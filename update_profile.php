...
$query="update donor_reg set name='$n',mobile='$mob',gender='$gen',hobbies='$hob',dob='$dob' where email='".$_SESSION['donor_reg']."'";
...
$sql=mysqli_query($conn,"select * from donor_reg where email='".$_SESSION['donor_reg']."'");
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					...
					<Td><input class="form-control" type="email" readonly="true" value="<?php echo $res['ename'];?>"  name="e"/></td>
				</tr>
				
				
				<tr>
					<td>Enter Your Mobile </td>
					<Td><input class="form-control" type="text" value="<?php echo $res['phn'];?>"  name="mob"/></td>
				</tr>
